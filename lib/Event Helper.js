...
var action = {
    ...
    attachEvents: function (element) {
        Platform.windows.on("create", function (win) {
            if (win.type === "normal") {
        ...
        Platform.tabs.on("create", function (tab) {
        ...
        Platform.tabs.on("update", function (id, info, tab) {
        ...
        Platform.tabs.on("move", function (id, info) {
        ...
        Platform.tabs.on("detach", function (id, info) {
        ...
        Platform.tabs.on("attach", function (id, info) {
        ...
        Platform.tabs.on("focus", function (id, info) {
            var list = state.windows[info.windowId],
                node = state.tabsByID[id];
        ...
        Platform.tabs.on("remove", function (id) {
            var list, node = state.tabsByID[id];
        ...
        Platform.windows.on("remove", function (id) {
