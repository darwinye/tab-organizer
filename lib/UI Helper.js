...
//            debugger;
//
//            console.log(height, node.offsetTop, node.offsetHeight);
        },
            ...
            var menu = {
                ...
                show: function (info) {
                    ...
                    if ("x" in info || "y" in info) {
                        ...
                        container.style.left = box.left - 2 + "px";
                        container.style.top = box.bottom - 15 + "px";
                    }*/
...
//                                padding.style.maxWidth = box.width - (box.right - root.clientWidth) + "px";
//                                padding.style.width = "100%";
//                            padding.style.right = "0px";
//
