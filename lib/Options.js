...
//                    throw new TypeError("The 3rd argument must be a boolean.");
        ...
        //            });
            ...
            remove: function (name, action, type) {
                if (typeof action !== "function") {
                    throw new TypeError("The 2nd argument must be a function.");
                }
                if (typeof type !== "boolean") {
...
//                };
        ...
        //                            !(info.eventPhase === Event.BUBBLING_PHASE);
                                ...
                                //console.log(phase);
        //                        Options.event.remove(info.type, item, phase);
                                console.error(e);
                            }
                        });
...
//        console.log(Options === page.Options);
        ...
        Options.event.on = (function () {
//            return Options.event.on;


            var saved = Options.event.on;
            var events = [];
//            var stop;

//            Options.event.on("unload", function anon(event) {
...
//                    page.console.log(item.action);
                    Options.event.remove(item.name, item.action, item.type);
                });
...
//                                console.log(type, +value);
                    ...
                    var types = {
                        "radio-list": function (info) {
                            ...
                            //var opt = Options.get(info.option);
...
//                                        Options.set(info.option, this.value);
...
//                        tooltip.removeEventListener("mouseover", timer, true);
//                        tooltip.removeEventListener("mousemove", show, true);
//                        hide();
...
//                        tooltip.addEventListener("mouseover", timer, true);
//                        tooltip.addEventListener("mousemove", show, true);
//                        show();
