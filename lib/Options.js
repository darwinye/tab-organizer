...
var Options = (function () {
    ...
    Options.sync = function (elem, info) {
        ...
        var defaultValue = Options.getDefault(info.option);
...
//        }
        ...
        return function () {
            if (typeof info.modify === "function") {
                Options.set(info.option, info.modify.call(elem));
...
Options.createContainer = (function () {
    ...
    var category = {
        ...
        input: (function () {
            var types = {
                "dropdown-list": function (info, span) {
            ...
            return function (type, info) {
                ...
                if (typeof types[type] === "function") {
                    types[type].call(line, info, left);
                }

                if (info.text instanceof Array) {
                    left.textContent = info.text[0];
                    right.textContent = info.text[1];
