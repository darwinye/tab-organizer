...
var Options = (function () {
    ...
    Options.addEventListener = function (name, func, type) {
        ...
        if (event[name].indexOf(func) === -1) {
            event[name].push(func);
        }
    };
    Options.removeEventListener = function (name, func, type) {
        if (typeof func !== "function") {
            throw new TypeError("The 2nd argument must be a function.");
        }
        if (typeof type !== "boolean") {
