...
//            var saved = obj.on;
            ...
            var events = [];
//
//            page.console.warn(clone.remove);
//
//            page.console.warn(page === global);
//            page.console.warn(addEventListener === page.addEventListener);
//            page.console.warn(addEventListener === global.addEventListener);
...
//                var self = this;
//
//                self.on(name, function anon() {
//                    self.remove(name, anon);
//
...
//                    };
//                    Object.freeze(info);
//                    Object.defineProperty(info, "type", {
//                        configurable: false,
//                        writable: false,
//                        value: name
//                    });
...
//        page.console.log(this);
        Options.event = Options.event.decouple(this);
    } else {
        Options = dictionary();
